...
public class GroupAssigner {
    ...
    public GroupAssigner(String studentFile, String topicsFile, int groupSize)
        ...
        /*
         * Reads two files and creates two lists with their contents: one of
         * students and other of topics.
         *
         */
        ...
        System.out.printf("Cantidad de estudiantes: %d\n", students.size());
    ...
    /**
     * Of the students list, takes one randomly and adds it to the group. Once
     * that student is added, the student is deleted of the list to prevent it
     * from being added to many groups.
     *
     * @param group
     */
    ...
    /**
     ** Of the topics list, takes one randomly and adds it to the group. Once
     * that topic is added, the topic is deleted of the list to prevent it from
     * being added to many groups.
     *
     * @param group
     */
    ...
    /**
     * Iterates over the remainder to group them in a random group.
     *
    ...
    public void assignRemainderStudentToGroup(int remainderStudents) {
        for (int i = 0; i < remainderStudents; i++) {
            ...
            /*
             *
             * * When the remainder student is added to the given group, needs
             * to be specified this group already contains a remainder student
             * to prevent an unbalance, for example, a group having 7 students
             * and other just 5.
             */
